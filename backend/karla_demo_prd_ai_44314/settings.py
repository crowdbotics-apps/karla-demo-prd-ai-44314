"""
Django settings for karla_demo_prd_ai_44314 project.
...
ROOT_URLCONF = 'karla_demo_prd_ai_44314.urls'
...
WSGI_APPLICATION = 'karla_demo_prd_ai_44314.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "karla_demo_prd_ai_44314 API",
    "DESCRIPTION": "API documentation for karla_demo_prd_ai_44314 App",
    "VERSION": "v1",
}
